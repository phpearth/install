...
This repository follows [semantic versioning](http://semver.org). When the
source code changes or new features are implemented, a new version (e.g. `1.x.y`)
is released by the following release process:
...
* **2. Tag a new release:**
    ...
    Tag a new release version on [GitHub](https://github.com/php-earth/install/releases),
